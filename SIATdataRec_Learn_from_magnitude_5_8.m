...
%% cartesian-85%
load test_data_mask_SIAT3\mask_cart_085.mat;
mask = mask_cart_085;
mask = fftshift(fftshift(mask,1),2);
%% radial-90%
% line = 30;
...
params.sigma_net = 5;  params.sigma_net2 = 8;

load('.\models\MWCNN_GDSigma5_3D_400\MWCNN_GDSigma5_3D_400-epoch-45');  net1 = net;
...
MEDMSPRec = Complex_DMSPMRIRec_2sigma(gt, zero_filled, partialdata, mask, params, net1, net2);
